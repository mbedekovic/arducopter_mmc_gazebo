...
class VelocityPublisher:
    ...
    def __init__(self):
        ...
        self.vel_pub = rospy.Publisher('/arducopter/velocity', TwistStamped, queue_size=1)
        self.euler_pub = rospy.Publisher('/arducopter/euler', Vector3Stamped, queue_size=1)
        rospy.Subscriber('/arducopter/sensors/pose1', PoseWithCovarianceStamped, self.pose_gt_cb)
